...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        String childrenName1 = reader.readLine();
        Cat catChildren1 = new Cat(childrenName1, catFather, catMother);

        String childrenName2 = reader.readLine();
        Cat catChildren2 = new Cat(childrenName2, catFather, catMother);

        System.out.println(grandFather);
        System.out.println(grandMother);
        System.out.println(catFather);
        System.out.println(catMother);
        System.out.println(catChildren1);
